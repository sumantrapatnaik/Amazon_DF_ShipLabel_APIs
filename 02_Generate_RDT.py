#Description: This code is am example for generating the AWS Signature V4 and use it to call the RDT generation endpoint
...
raw_payload +=','
raw_payload += '{"method": "GET",'
raw_payload += '"path": "/vendor/directFulfillment/shipping/v1/shippingLabels/{litun}"'
raw_payload +='}'
raw_payload +=']'
raw_payload +='}'
