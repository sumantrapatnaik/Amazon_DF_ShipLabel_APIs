...
#endpoint = 'https://sandbox.sellingpartnerapi-na.amazon.com/vendor/directFulfillment/shipping/v1/shippingLabels'

#LWA Access Token received in response of the above API call
access_token = r_access_token

# Payload for SubmitShipLabel - Passed in a JSON block.
raw_payload ='{'
raw_payload += '"shippingLabelRequests": '
raw_payload += '['
raw_payload += '{"purchaseOrderNumber": "",'            #Purchase Order Number
raw_payload += '"sellingParty": {"partyId": ""},'       #Vendor Code
raw_payload +='"shipFromParty": {"partyId": ""}'        #Warehouse ID
raw_payload +='}'
raw_payload +=']'
raw_payload +='}'
