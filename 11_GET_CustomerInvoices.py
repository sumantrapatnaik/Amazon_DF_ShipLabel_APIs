#Description: This code is am example for generating the AWS Signature V4 and use it to call DF SP API GET Shipping Labels using RDT
...
raw_payload += '"path": "/vendor/directFulfillment/shipping/v1/customerInvoices"'
raw_payload +='}'
raw_payload +=','
raw_payload += '{"method": "GET",'
raw_payload += '"path": "/vendor/directFulfillment/shipping/v1/customerInvoices/{litun}"'    #{something} this value can be any string
raw_payload +='}'
raw_payload +=']'
raw_payload +='}'
...
#BEGIN***********For calling GET Customer Invoices*****************
method = 'GET'
service = 'execute-api'
host = 'sellingpartnerapi-na.amazon.com'
region = 'us-east-1'
endpoint = 'https://sellingpartnerapi-na.amazon.com/vendor/directFulfillment/shipping/v1/customerInvoices'
...
# Query Parameter values in the GET Customer Invoices call.
createdAfterDate = "2022-01-01T14:00:00-08:00"
createdBeforeDate = "2022-04-28T14:00:00-08:00"
limitValue = "2"
sortOrder = "DESC"

#canonical_uri is the URI-encoded version of the absolute path component of the URI—everything starting with the "/" that follows the domain name and up to the end of the string or to the question mark character ('?') if you have query string parameters 
canonical_uri = "/vendor/directFulfillment/shipping/v1/customerInvoices" 
...
canonical_querystring = uriEncode("createdAfter")+ "=" + uriEncode(createdAfterDate)+"&"
canonical_querystring += uriEncode("createdBefore")+ "=" + uriEncode(createdBeforeDate)+"&"
canonical_querystring += uriEncode("limit")+ "=" + uriEncode(limitValue)+"&"
canonical_querystring += uriEncode("sortOrder")+ "=" + uriEncode(sortOrder)
...
print(json_formatted_str)
#END***********For calling GET Shipping Labels*****************
