...
region = 'us-east-1'
#endpoint = 'https://sellingpartnerapi-na.amazon.com/vendor/directFulfillment/shipping/v1/shipmentConfirmations'
endpoint = 'https://sandbox.sellingpartnerapi-na.amazon.com/vendor/directFulfillment/shipping/v1/shipmentConfirmations'

#LWA Access Token received in response of the above API call
access_token = r_access_token

# Payload for SubmitShipmentConfirmation - Passed in a JSON block.
raw_payload = '{'
raw_payload +=	'"shipmentConfirmations": ['
raw_payload +=		'{'
raw_payload +=			'"purchaseOrderNumber": "2JK3S9VCD",'
raw_payload +=			'"shipmentDetails": {'
raw_payload +=				'"isPriorityShipment": true,'
raw_payload +=				'"shippedDate": "2021-07-13T22:31:47.020Z",'
raw_payload +=				'"shipmentStatus": "FLOOR_DENIAL"'
raw_payload +=			'},'
...
raw_payload +=			'"items": ['
raw_payload +=				'{'
raw_payload +=					'"buyerProductIdentifier": "B07FCKXGKC",'
raw_payload +=					'"itemSequenceNumber": 1,'
raw_payload +=					'"shippedQuantity": {'
raw_payload +=						'"amount": 1,'
raw_payload +=						'"unitOfMeasure": "Each"'
raw_payload +=					'}'
raw_payload +=				'}'
raw_payload +=			'],'
raw_payload +=			'"containers": ['
raw_payload +=				'{'
raw_payload +=					'"containerType": "carton",'
raw_payload +=					'"containerIdentifier": "123",'
raw_payload +=					'"packedItems": ['
raw_payload +=						'{'
raw_payload +=							'"itemSequenceNumber": 1,'
raw_payload +=							'"buyerProductIdentifier": "B07DFVDRAB",'
raw_payload +=							'"packedQuantity": {'
raw_payload +=								'"amount": 1,'
raw_payload +=								'"unitOfMeasure": "Each"'
raw_payload +=							'}'
raw_payload +=						'}'
...
#canonical_uri is the URI-encoded version of the absolute path component of the URI—everything starting with the "/" that follows the domain name and up to the end of the string or to the question mark character ('?') if you have query string parameters 
canonical_uri = "/vendor/directFulfillment/shipping/v1/shipmentConfirmations" 
