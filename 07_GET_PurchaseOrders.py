...
raw_payload += '"path": "/vendor/directFulfillment/orders/v1/purchaseOrders"'
raw_payload +='}'
raw_payload +=','
raw_payload += '{"method": "GET",'
raw_payload += '"path": "/vendor/directFulfillment/orders/v1/purchaseOrders/{litun}"'    #{something} this value can be any string
raw_payload +='}'
raw_payload +=']'
raw_payload +='}'
...
#BEGIN***********For calling GET Shipping Labels*****************
method = 'GET'
service = 'execute-api'
host = 'sellingpartnerapi-na.amazon.com'
region = 'us-east-1'
endpoint = 'https://sellingpartnerapi-na.amazon.com/vendor/directFulfillment/orders/v1/purchaseOrders'
...
# Query Parameter values in the GET Purchase Orders call.
...
#canonical_uri is the URI-encoded version of the absolute path component of the URI—everything starting with the "/" that follows the domain name and up to the end of the string or to the question mark character ('?') if you have query string parameters 
canonical_uri = "/vendor/directFulfillment/orders/v1/purchaseOrders" 
...
canonical_querystring += uriEncode("status")+ "=" + uriEncode(status)
